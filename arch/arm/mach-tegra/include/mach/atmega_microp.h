/* arch/arm/mach-tegra/include/mach/atmega_microp.h
 *
...
#define MICROP_I2C_WCMD_JOGBALL_LED_MODE_TIME_BLINKING		0x5D
#define MICROP_I2C_WCMD_JOGBALL_LED_MODE_TIME_BREATHING 	0x5F
...
struct microp_ops {
	...
	// Modify by ShihHao ====================================================
	// For changing power sequence. 
	void (*i2c_microp_poweron_func)(void);
	void (*i2c_microp_poweroff_func)(void);
	void (*i2c_microp_suspend)(void);
	void (*i2c_microp_resume)(void);
	// ======================================================================
